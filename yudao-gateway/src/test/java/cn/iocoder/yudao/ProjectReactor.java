...
public class ProjectReactor {
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.ape";
        String artifactIdNew = "ape";
        String packageNameNew = "cn.ape";
        String titleNew = "Ape管理系统";
        String projectBaseDirNew = "D:\\workspace\\" + "ape-new"; // 一键改名后，“新”项目所在的目录
